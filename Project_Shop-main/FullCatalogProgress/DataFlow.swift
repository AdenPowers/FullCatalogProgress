        ...
        do {
            ...
            for blueprint in blueprints {
                ...
                do {
                    ...
                    // Enrich provider metadata with structured addresses
                    for index in printProviders.indices {
                        if let detail = try? await fetchPrintProviderDetail(for: printProviders[index].id) {
                            printProviders[index].address = detail.address
                        }
                    }
                } catch {
